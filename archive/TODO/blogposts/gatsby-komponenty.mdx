...
Jest to podstawowe narzędzie tworzenia layoutu.
...
Ponadto pamiętajmy, że typowy układ strony jest prosty i przewidywalny. Patrząc od góry strona zaczyna się od nagłówka, potem mamy treść a na samym dole stopka. menu nawigacyjne może być częścią nagłówka lub może zostać umiezczone w pasku bocznym. Ten układ ma odzwieciedlenie w nowych, wprowadzonych z HTML5 tagach semantycznych: header, aside, main, article, footer, oraz nav.
