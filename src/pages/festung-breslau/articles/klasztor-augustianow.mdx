...
![klasztor augustianów](../img/1084px-5227_Wyspa_i_Most_Piaskowy.jpg)
...
Klasztor augustianów stał się własnością państwa i szybko okazało się, że tak naprawdę nie ma zbyt wielu chętnych na tak dobrą ale i kosztowną lokalizację więc stał się miejscem gdzie gromadzono dokumenty i zawartość bibliotek ze wszystkich likwidowanych na Śląsku klasztorów. Akcji tej nie przeprowadzano zbyt systematycznie, ilość ocalałych dokumentów zależała od tego ile wozów dostarczyły lokalne władze, dlatego stan zachowania księgozbiorów jest bardzo zróżnicowany.
...
Jak wiemy nowa siedziba została wyznaczona rzeczywiście dość wcześnie, choć Ahlfen nie wspomina dokładnie kiedy ale było to już w lutym, o budynku poklasztornym pisze
...
- Teresa Kulak "Historis Uniwersytetu Wrocławskiego 1702-2002"