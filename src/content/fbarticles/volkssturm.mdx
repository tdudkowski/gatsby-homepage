...
Artykuł powstał podczas pisania niniejszej kroniki, jego uzupełnieniem są dwa poniższe artykuły:
...
- Nie było też kiedy ich wyszkolić, w zakładach zbrojeniowych wprowadzono 78h tydzień pracy, więc na szkolenie przeznaczona była niedziela i to tylko 6 godzin włączając drogę tam i z powrotem.

Ostatecznie, chociaż patronat nad Volkssturmem miała Partia, szkolenie i zaopatrzenie powierzono armii.

Struktura organizacyjna była maksymalnie uproszczona: tylko cztery stopnie w ogóle nie nawiązujące do hierarchii wojskowej: szeregowy, dowódca drużyny, dowódca plutonu i dowódca batalionu. Podobnie jak w przypadku SS TKV nie było formacji powyżej szczebla batalionu. Batalion miał liczyć 360 do 640 ludzi.

Formalnie podlegał gauleiterom, ale na lini frontu działał pod komendą armii.

![Volkssturm](../img/Bundesarchiv_Bild_146-1979-107-10,_Angetretene_Volkssturmmänner.jpg)
...
Volsksturm przez swoje zaangażowanie, znajomość terenu odegra w bitwie o Wrocław poważną rolę. Więcej o formowaniu się garnizonu, wtedy kiedy cały proces zostanie domknięty: 26 stycznia.
